...
from myapp.members.models import User, Friendship
from myapp.chat.models import Conversation, Message
from myapp.ai_robot import get_robot_user, ROBOT_DISPLAY_NAME
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Message.objects.get_or_create(conversation=conv, sender=alice, content='你好，欢迎使用 MyWeb Chat')
